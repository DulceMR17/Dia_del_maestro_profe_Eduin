...
* `fix(paciencia)`: Soporte integrado para todas las dudas y código que no compila.
* `perf(clase)`: Optimización de nuestro futuro gracias a sus consejos y enseñanzas.
(Clone el repo y ejecute el archivo "Para_profe_Eduin.html" en su navegador )
